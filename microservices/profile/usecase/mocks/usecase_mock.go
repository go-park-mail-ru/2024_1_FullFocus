...
// Package mock_profilegrpc is a generated GoMock package.
package mock_profilegrpc
...
func (m *MockProfile) UpdateProfile(ctx context.Context, uID uint, newProfile models.ProfileUpdateInput) error {
	m.ctrl.T.Helper()
...
func (mr *MockProfileMockRecorder) UpdateProfile(ctx, uID, newProfile interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateProfile", reflect.TypeOf((*MockProfile)(nil).UpdateProfile), ctx, uID, newProfile)
}
