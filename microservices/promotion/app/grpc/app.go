...
import (
	...
	promotiongrpc "github.com/go-park-mail-ru/2024_1_FullFocus/microservices/promotion/grpc"
)
...
func New(log *slog.Logger, service promotiongrpc.Promotion, cfg config.Promotion) *App {
	...
	promotiongrpc.Register(gRPCServer, service)
...
func (a *App) Run() error {
	...
	if err != nil {
		return fmt.Errorf("promotion run error: %w", err)
	}
	...
	if err = a.gRPCServer.Serve(l); err != nil {
		return fmt.Errorf("promotion serve error: %w", err)
	}
	return nil
}

func (a *App) Stop() {
	a.logger.Info("stopping promotion gRPC server...", slog.String("port", a.config.Server.Port))
	a.gRPCServer.GracefulStop()
	a.logger.Info("promotion gRPC server stopped")
}
